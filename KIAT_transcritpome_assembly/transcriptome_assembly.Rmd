...
# Run ./trimming.sh in a screen # (Trimmomatic + Illuminaclip)
>>>>>>> 5dff38a549183772010ffe93f5f394b7160bbcb0
...
# ./run_cap3_cds.sh
# 
# 10) Blastx on Cluster

# 11) Generating Unmapped Cds Files
...
# awk 'BEGIN{RS=">"}NR>1{sub("\n","\t"); gsub("\n",""); print RS$0}' Ae_ref_for_annotation.fa > Ae_ref_for_annotation.tab
# cat Ae_ref_for_annotation.tab | grep -v "ne=XLOC_091616" | sort | uniq > Ae_ref_for_annotation_final.tab
...
# cat Brassica_napus_GO Ol_GOseq > Ol_Brassica_GOseq # Combining Reference GO and Da-Ol GO
...
# Ae.DEgene.GO.ORA.gt <- GOseq.Bn.ORA(Ae.GOseq.ID$V1)
